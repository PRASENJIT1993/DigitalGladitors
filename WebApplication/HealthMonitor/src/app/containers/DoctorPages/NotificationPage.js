...
class NotificationPage extends React.Component {
  ...
  componentWillMount() {
    this.props.actionHandler(postData(ActionConstants.GET_NOTIFICATION_DATA_BY_ID, {
      userId: this.props.userId,
      userType: this.props.userName.toLocaleLowerCase()
    }));
    this.props.actionHandler(navigateToAction(ActionConstants.NAVIGATION_LINK_TEXT.DOCTOR_NOTIFICATION_LINK, ActionConstants.NAVIGATION_PAGE_HEADER.DOCTOR_NOTIFICATION_HEADER));
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(withWidth()(NotificationPage));