...
import DoctorReports from '../../presentations/Reports/DoctorReports';
...
class ReportsPage extends React.Component {
  ...
  componentWillMount() {
    this.props.actionHandler(navigateToAction(ActionConstants.NAVIGATION_LINK_TEXT.DOCTOR_REPORTS_LINK, ActionConstants.NAVIGATION_PAGE_HEADER.DOCTOR_REPORTS_HEADER));
  }

  render() {
    return (
      <div>
        <DoctorReports {...this.props} />
      </div>
    );
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(withWidth()(ReportsPage));